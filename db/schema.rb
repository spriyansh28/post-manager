...
ActiveRecord::Schema.define(version: 2021_04_23_133916) do
  ...
  create_table "technologies", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id"], name: "index_technologies_on_post_id"
  end

  create_table "use_rs", force: :cascade do |t|
    t.string "name"
    t.bigint "post_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id"], name: "index_use_rs_on_post_id"
  end
